    ...
    func start() {
        ...
        timelineViewModel.actions.sink { [weak self] action in
            ...
            case .displayEmojiPicker, .displayReportContent, .displayCameraPicker, .displayMediaPicker,
                 .displayDocumentPicker, .displayLocationPicker, .displayNewPollForm, .displayEditPollForm, .displayStickerPicker,
                 .displayMediaUploadPreviewScreen, .displayResolveSendFailure, .displayThread, .composer, .hasScrolled, .displayRoom,
                 .displayMediaDetails, .presentCallScreen:
